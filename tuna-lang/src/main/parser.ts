...
export type globals_$0_$0_1 = ws[];
export type globals_$0_$0_2 = string;
    ...
    public matchglobals_$0($$dpth: number, $$cr?: ContextRecorder): Nullable<globals_$0> {
        return this.runner<globals_$0>($$dpth,
            (log) => {
                ...
                let $scope$value: Nullable<constant>;
                let $$res: Nullable<globals_$0> = null;
                if (true
                    && ($scope$value = this.matchconstant($$dpth + 1, $$cr)) !== null
                    && this.matchglobals_$0_$0($$dpth + 1, $$cr) !== null
                ) {
