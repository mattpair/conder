...
* varDecl := ws* mutability={'const' | 'var'} ws+ name=name ws* equals ws* value=expression
* name := name='[a-zA-Z]+\w*'
* equals := '='
* ws := '\s'
...
export type varDecl_$0_1 = string;
export type varDecl_$0_2 = string;
...
export class Parser {
    ...
    public matchvarDecl_$0_2($$dpth: number, $$cr?: ContextRecorder): Nullable<varDecl_$0_2> {
        return this.regexAccept(String.raw`(?:var)`, $$dpth + 1, $$cr);
    }
