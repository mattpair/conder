...
export type AnyNode = {
    [K in BaseNodeDefs["kind"]]: Omit<Extract<BaseNodeDefs, {kind: K}>, "_meta">
}[BaseNodeDefs["kind"]]

export type RootNode = PickNode<Extract<BaseNodeDefs, {_meta: "root"}>["kind"]>
export type PickNode<K extends BaseNodeDefs["kind"]> = Extract<AnyNode, {kind: K}>
