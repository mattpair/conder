...
type SchemaFactory = Readonly<{
    ...
    P extends "Role" ? (name: string, r: Record<string, SchemaInstance<SchemaType>>) => SchemaInstance<"Role"> :
...
P extends "Role" ? {kind: "Role", data: [string, Record<string, SchemaInstance<SchemaType>>]} :
never;
